OpenWanderer absolute basic example application 
===============================================

This is an absolute basic example OpenWanderer web application, making use of the new Composer package for the server `openwanderer/openwanderer`. For a fuller application with more functionality, please see the `full` directory.
